...
func (s *server) EmitirFeromona(ctx context.Context, in *pb.FeromonaLBH) (*pb.FeromonaRespuesta, error) {
    ...
    return &pb.FeromonaRespuesta{Code: 200, Message: "feromona_aceptada", Nodo: in.Nodo}, nil
}
